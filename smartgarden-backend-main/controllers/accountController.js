...
const accountController = {
    ...
    updateAccountData: async (req, res) => {
        try {
            ...
            // Đầu vào: Dữ liệu mới của tài khoản (trừ gardenList)
    ...
    deleteUserOfAdmin: async (req, res) => {
        try {
            ...
            deleteUser.gardenList.map((garden) =>
                garden.findByIdAndUpdate(garden._id, {
                    $pull: {
