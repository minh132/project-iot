...
import { thunkGetGardenData } from "features/Garden/gardenSlice";
...
function ModalCreateRoom(props) {
    ...
    // MARK: --- Params ---
    const { show, onClose, gardenId } = props;
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            const params = { gardenId: gardenId, ...values };
            try {
                ...
                if (res.payload.result === "success") {
                    ...
                    await dispatch(thunkGetRoomsList({ gardenId: gardenId }));
                }
            } catch (err) {
